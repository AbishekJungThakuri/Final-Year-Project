...
import {
  fetchPlacesThunk,
  fetchNearestCitiesThunk,
  fetchCitiesThunk,
} from "../../features/plan/LocationSlice";
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm space-y-4">
          ...
          <div className="relative">
            ...
            <input
              type="text"
              placeholder={
                category === "visit" ? "Search places..." : "Search cities..."
              }
              value={searchTerm}
              onChange={(e) => {
        ...
        {(placesLoading || citiesLoading) && (
          <div className="text-center py-8">
            ...
            <p className="mt-2 text-gray-600">
              Loading {category === "visit" ? "places" : "cities"}...
            </p>
          </div>
        )}

        {(category === "visit" || category === "activity") &&
          !placesLoading && (
                        ...
                        <div className="p-1 flex items-center space-x-4">
                          ...
                          >
                            ...
                            <div className="text-sm flex items-center flex-wrap">
                              ...
                              <div className="w-1 h-1 rounded-full bg-muted-foreground mx-2" />
                              <span>
                                {formatTime(place.average_visit_duration)}
                              </span>
                            </div>
                                ...
                                <div className="p-1 flex items-center space-x-4">
                                  ...
                                  <div className="flex-1 space-y-2">
                                    ...
                                    <div className="flex items-center space-x-4 text-sm text-gray-500">
                                      <div className="text-sm flex items-center flex-wrap">
                                        <span>
                                          {placeActivity.activity.name}
                                        </span>
                                        <div className="w-1 h-1 rounded-full bg-muted-foreground mx-2" />
                                        <span>
                                          {formatCost(
                                            placeActivity.average_cost
                                          )}
                                        </span>
                                        <div className="w-1 h-1 rounded-full bg-muted-foreground mx-2" />
                                        <span>
                                          {formatTime(
                                            placeActivity.average_duration
                                          )}
                                        </span>
                                      </div>
                                    </div>
